...
public class GobsProperties
{
	...
	private final static String PICTURE_BASE_NAME = "growing-triangles-09";
	...
	public final static int TRIANGLE_RELEASE_RATE = 100;
	...
	protected static final float TRIANGLE_ORIGINAL_SIZE = (float) 1;
	protected static final float TRIANGLE_SIZE_INCREMENT = (float) 0.05;
	protected static final float TRIANGLE_WIDTH_RATIO = (float) 1.5;
