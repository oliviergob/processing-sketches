...
public class GobsProperties
{
	...
	public static final int GIF_NB_FRAME = 49;
	...
	protected static final float TRIANGLE_ORIGINAL_SIZE = (float) 0.1;
	protected static final float TRIANGLE_SIZE_INCREMENT = (float) 0.02;
